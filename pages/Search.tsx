    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-3xl mx-auto mb-16">
        <h1 className="text-3xl md:text-4xl font-black text-white text-center mb-8">
          Find your next <span className="text-blue-500">obsession</span>
        </h1>
      ...
      <div className="min-h-[40vh]">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-slate-400">Searching the archive...</p>
          </div>
        ) : searched ? (
          <div>
            <div className="flex items-center justify-between mb-8 border-b border-slate-800 pb-4">
               ...
               <span className="text-slate-500">{results.length} results found</span>
            </div>
            {results.length > 0 ? (
              ...
              <div className="text-center py-20">
                <p className="text-slate-500 text-xl">No dramas found matching your search.</p>
                <button 
                  onClick={clearSearch}
          ...
          <div className="flex flex-col items-center justify-center py-20 opacity-40">
            ...
            <p className="text-slate-600 font-medium text-xl">Enter a title to browse our library</p>
          </div>
        )}
      </div>
    </div>
